...
INSERT INTO oauth_client_details
	...
	refresh_token_validity, additional_information, autoapprove)
VALUES
	("core_client", "$2a$10$ePZ9kwbN2JyipmgJeCT4RudBZJ5Cwt6HeI1KzdHwJt37.WUFAE.a2", "read,write,delete,update", "password,authorization_code,refresh_token", null, null, 36000, 36000, null, true);
...
INSERT INTO oauth_client_details
	...
	refresh_token_validity, additional_information, autoapprove)
VALUES
	("example_client", "$2a$10$ePZ9kwbN2JyipmgJeCT4RudBZJ5Cwt6HeI1KzdHwJt37.WUFAE.a2", "read,write,delete,update", "password,authorization_code,refresh_token", null, null, 36000, 36000, null, true);